...
- **Update (2026-08-17, per VoltPop):** at least one guest speaker on behalf of ASF is **semi-confirmed** via VoltPop's own ASF ties — full confirmation contingent on the course actually being sold/greenlit. Flagging rather than merging with the row above: not yet confirmed whether this is the same Rich Bowen commitment restated with a firmer real-world caveat, or a second, additional speaker.
