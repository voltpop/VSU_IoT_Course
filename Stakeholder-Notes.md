...
- **Owner:** VoltPop. **Status:** direct outreach in progress — due Aug 4–7 (TODOs-by-Owner.md). Next step: call the Newport News office and ask for the Academic Programs Coordinator, or route through VSU's Engineering Department for a warmer intro (see IAC contact below).
