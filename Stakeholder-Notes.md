...
- **Contact:** *(not yet sourced)*. **Better contact found — VSU Engineering Industry Advisory Council (vsu.edu, 2026-08-02):** Dominion Energy already sits on VSU's own Department of Engineering IAC, represented by **Daniel Holmes, Technical Specialist II – Electric Distribution Technology Applications**. Like Siemens, this is an existing VSU-side relationship — probably reachable through the Engineering Department/Dean Haley rather than cold outreach to Dominion directly, and it partially answers the "what's in it for them" open question above: they're already institutionally engaged with VSU's Engineering program specifically.
