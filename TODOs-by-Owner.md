...
11. **Aug 21** — Client presentation created & delivered — the milestone itself *(shared, confirmed by VoltPop 2026-08-04: all)*.
...
4. **[Due mid-Aug 2026]** Lead Cameron Foundation outreach *(shared: VoltPop, support if needed — per VoltPop, 2026-08-03)* — fill in `Stakeholder-Notes.md`'s Cameron Foundation profile as this progresses (Admin-Business-Legal.md §8).
...
8. **[Due date no longer applicable, flagged 2026-08-06]** Monitor NSF HBCU-UP for its next solicitation — the prior one (NSF 23-563) is confirmed no longer active ("not currently accepting proposals," per NSF's own page); there is nothing to submit against right now, so this shifts from "write the application by mid-Aug" to "watch for the next solicitation's publication" (Admin-Business-Legal.md §8; Stakeholder-Notes.md).
...
21. *(new, flagged 2026-08-06, per VoltPop — no owner yet beyond Dr. Nicholson himself, since content likely needs VoltPop/Explay/Builder Tech input too)* Build a distinct "sell VSU on hosting this" pitch for Dean Haley and the incoming Reginald F. Lewis College of Business dean — a different deck than any funder-facing one, since nothing here is a cash ask; the ask is lab/classroom access, faculty time, curriculum integration, and FERPA/liability sign-off (Stakeholder-Notes.md's "VSU's own colleges" section).
22. *(new, flagged 2026-08-06, per VoltPop, not yet confirmed)* Confirm with VSU whether College of Engineering and Technology and Reginald F. Lewis College of Business could actually split the program's core cost between them, with external funding reducing that further rather than needing to close the full ~$295K–$311K gap alone — changes the size of the external ask and the nature of the pitch to both colleges if true (Admin-Business-Legal.md §8; Stakeholder-Notes.md).
23. *(new, flagged 2026-08-06)* Decide whether VSU's College of Agriculture (with its Agricultural Research Station) should be formally added as a third institutional-coordination target alongside CoET and Reginald F. Lewis College of Business — directly relevant given the AI-agriculture angle developed for Southern Company, currently untracked with no owner or POC (Stakeholder-Notes.md's "VSU's own colleges" section).
